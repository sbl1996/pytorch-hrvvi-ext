...
class RPN(Sequential):
    ...
    def __init__(self, backbone, fpn, head, inference=None, return_features=True):
...
class RCNN(nn.Module):
    ...
    def forward(self, x):
        ps, image_dets = self.rpn.region_proposal(x)
