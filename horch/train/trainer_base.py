...
from typing import Sequence, Callable, Union, Optional, Mapping
...
from horch.train.callback import Events, Checkpoint, Callback
...
class TrainerBase:
    ...
    def __init__(self,
        ...
        self._kwargs = kwargs
        self._verbose = True
        self._prev_train_engine_state = None
    ...
    def load(self, fp=None):
        ...
        if "train_engine" in state_dict:
            self._prev_train_engine_state = state_dict['train_engine']
    ...
    def fit(self,
        ...
        if self._prev_train_engine_state:
            self.train_engine.load_state_dict(self._prev_train_engine_state)
        ...
        if save_by:
            checkpoint = Checkpoint({
                ...
                **self.to_save()
            }, save_freq=save_by, save_dir=self.work_dir, n_saved=1)
        ...
        try:
            ...
            self._prev_train_engine_state = self.train_engine.state_dict()
